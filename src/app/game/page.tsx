...
import cenarioLab from "../../../public/cenarioLab.jpg";
                    ...
                    {page == 1 ? (
                        <>
                            ...
                            <div className="flex text-blue-800 p-1 gap-1 flex-col w-11/12 absolute self-end bg-amber-100 rounded outline">
                                ...
                                <button className={` ${option == 3 ? "animate-gameboy-pulse-pokemon font-semibold bg-amber-50" : ""} outline outline-blue-800 p-1 rounded`}>Multiplayer {option == 3 ? "<" : ""}</button>
                            </div>
                        </>
                    ) : page == 2 ? (
                        <>
