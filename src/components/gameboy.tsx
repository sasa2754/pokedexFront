...
export const Gameboy = ({ children } : IGameboy) => {
    return (
        <div className="flex h-full itens-center justify-center w-full">
            <div className="bg-gray-300 h-5/6 w-full m-2 p-3 md:max-w-[30rem] md:min-h-[50rem] rounded-2xl shadow-2xl">
                ...
                <div className="flex flex-col items-center justify-center py-5 h-full">
                    <div className="flex justify-between w-full p-3 md:px-5">
                        ...
                        <div className="flex gap-1 -rotate-[30deg] bg-neutral-400 h-12 w-[5.3rem] md:w-32 md:h-15 inset-shadow-2xs justify-around p-1 self-center rounded-4xl">
                            <button>
                    ...
                    <div className="flex gap-1 mt-8">
                        <div className="flex flex-col justify-center gap-3 text-gray-700">
                            <button className="-rotate-[30deg]">
                                <div className="w-10 h-3 aspect-video bg-gray-600 rounded shadow ease-in-out duration-200 active:scale-95 cursor-pointer"></div>
                            </button>
                            <h1>Start</h1>
                        </div>
                        <div className="flex flex-col justify-center gap-3 text-gray-700">
